...
class Config:
    ...
    gemini_temperature: float = 1  # 温度参数（0.0-2.0，控制输出随机性，默认0.7）
    ...
    anthropic_temperature: float = 1  # Anthropic temperature (0.0-1.0, default 0.7)
    ...
    openai_temperature: float = 1  # OpenAI 温度参数（0.0-2.0，默认0.7）
